...
def buy_button(user_id, ticker):
    url = f'http://www.tinkoff.ru/invest/stocks/{ticker}?utm_source=mayak_bot&utm_content={user_id}'
    buttons = [[InlineKeyboardButton('Купить', callback_data=f'buy_share', url=url)]]
    # TODO callback_data нужно добавить user_id и ticker?
